...
import com.zerodeg.chatrecyclerview.databinding.ChatItemForSendBinding
import com.zerodeg.chatrecyclerview.model.ChatModel

class SentMessageHolder(itemView: View, iChat: ChatInterface) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
    ...
    * */
    ...
    private var item :ChatItemForSendBinding? = ChatItemForSendBinding.bind(itemView)
